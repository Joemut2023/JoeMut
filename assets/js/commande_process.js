(() => {
  ...
  form_finalisation.addEventListener("submit", async (e) => {
    ...
    let isLoadingCmd = document.querySelector(".preload");
    ...
    let commande_debut = document.querySelector(
      "[name=com_debut_spectacle]"
    ).value;
    let com_fin_spectacle = document.querySelector(
      "[name=com_fin_spectacle]"
    ).value;
