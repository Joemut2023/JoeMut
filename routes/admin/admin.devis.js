...
const {
    Commande,Panier, 
    Panier_detail,Client,
    Tarif,Frais_port,Essayage,
...
router.get('/',async (req,res)=>{
    try {
        ...
        let commandes = await Commande.findAll({
            attributes: [
                'com_id','com_date','com_debut_spectacle','com_fin_spectacle','pan_id','frp_id',
                [Sequelize.fn('SUM', Sequelize.col('Panier.Panier_details.pad_ttc')), 'total_pad_ttc']
            ],
            include: [
