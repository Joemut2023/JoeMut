...
var btnDocFormNotes = document.querySelectorAll('.btn-form-doc-note');
var btnDocFormPaiements = document.querySelectorAll('.btn-form-doc-paiement');
 ...
 */
btnDocFormNotes.forEach(function (btnDocFormNote) {
  btnDocFormNote.addEventListener('click', function (e) {
    var documentId = e.target.dataset.document;
    var trFormNote = document.querySelector(".tr-form-note-".concat(documentId));
 ...
 */
btnDocFormPaiements.forEach(function (btnDocFormPaiement) {
  btnDocFormPaiement.addEventListener('click', function (e) {
    var documentId = e.target.dataset.document;
    var trFormPaiement = document.querySelector(".tr-form-paiement-".concat(documentId));
