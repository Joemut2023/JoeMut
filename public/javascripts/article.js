...
var small_img_carousel = document.querySelector(".small_carousel");
...
btnAjouter.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var qte, itemId, produit;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        qte = input.value;
        itemId = parseInt(btnAjouter.dataset.id);
        _context.next = 4;
